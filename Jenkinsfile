...
pipeline {
    ...
    post {
	success {
	    archiveArtifacts artifacts: 'goes-build/*.deb,goes-build/*.rom,goes-build/*.zip,goes-build/worktrees/*/linux/*.changes,goes-build/worktrees/*/linux/*.buildinfo,goes-bmc/goes-platina-mk1-bmc,goes-boot/goes-boot,goes-example/goes-example,goes-example/goes-example-arm,goes-platina-mk1/goes-platina-mk1,vnet-platina-mk1/vnet-platina-mk1'
